...
var sequel = `The sequel to my book is called the ${title} 2`;
...
var books = [`The House`, `The Girl`, `The Dragon`, `The Monster`, `The Boy`];
...
// different numbers below two hundred.
 var belowTwoHundred = [22, 99, 88, 55, 33, 11, 77, 66, 44, 21, 31, 41,];
